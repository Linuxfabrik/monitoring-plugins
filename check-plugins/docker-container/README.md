...
options:
  ...
  --no-perfdata         Suppress the performance data section from the output.
                        ...
                        dropped.
  --status STATUS       Desired container status. Docker reports one of
                        `created`, `running`, `paused`, `restarting`,
                        `removing`, `exited` and `dead`. A container whose
...
Documentation:
https://linuxfabrik.github.io/monitoring-plugins/check-plugins/docker-container/
```

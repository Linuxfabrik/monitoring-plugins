...
options:
  ...
  --ignore IGNORE       Skip HyperMetro domains. Any item matching this Python
                        ...
                        against `UUID`, `NAME`, so prefix with `.*` to match
                        anywhere.
  ...
  --no-insecure         Verify the TLS certificate against the system trust
                        ...
                        system trust store.
  --match MATCH         Limit to HyperMetro domains. Filter by this Python

...
options:
  ...
  --path PATH           Path to the Valkey binary. Resolved via $PATH when
                        given without a directory. Default: valkey-server
...
Documentation:
https://linuxfabrik.github.io/monitoring-plugins/check-plugins/valkey-version/
```
